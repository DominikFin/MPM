...
For the final model deployment, the project team would choose a linear model. First, the linear model is easier to interpret and second, the non-parametric models showed only slightly more accuracy. It also makes sense from a computational perspective, as the model must predict a price within seconds to ensure customer satisfaction.
